...
def check_process():
    ...
    :return: if something went wrong false and changes global msg to the error
    ...
    # if AssertionError occurred it returns a tuple(false, why it failed)
        ...
        msg = "Encryption process failed, " + str(why)
        return False
    ...
    if conformation == "Data was encrypted successfully!":
        ...
        if data != ENCRYPTION_CHECK:
            msg = "Encryption failed (incorrect values)"
            return False
