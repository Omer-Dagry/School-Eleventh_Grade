...
def upload_file(user_name, other_username, file_size, file_ends_with, current_socket):
    ...
    file_name_other = read_file('chats\\' + user_name + "\\" + "file_count_" + other_username + ".txt")
    ...
    data = read_file('chats\\' + user_name + "\\" + other_username + ".txt")
    data += user_name + ": #@??##" + file_name_user + file_ends_with + "#@?!#"
    write_file('chats\\' + user_name + "\\" + other_username + ".txt", data)
    data = read_file('chats\\' + other_username + "\\" + user_name + ".txt")
    data += user_name + ": #@??##" + file_name_other + file_ends_with + "#@?!#"
    write_file('chats\\' + other_username + "\\" + user_name + ".txt", data)
    new_data(user_name)
    new_data(other_username)
    write_file('chats\\' + other_username + "\\" + file_name_other + file_ends_with, file_data, mode="wb")
    return write_file('chats\\' + user_name + "\\" + file_name_user + file_ends_with, file_data, mode="wb")
