...
def handle_client(client_socket: EncryptedSocket, client_address: tuple[str, int]):
    """
...
def main():
    server_socket = EncryptedSocket(cert_file=os.path.abspath("private_key_and_crt\\certificate.crt"),
